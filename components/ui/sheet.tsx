  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          "data-[state=open]:animate-in data-[state=closed]:animate-out overflow-auto fixed z-50 flex flex-col gap-4 transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 p-4",
          side === "right" &&
      ...
      >
        {/* Content */}
        <div className="relative bg-background shadow-xl rounded-lg border">
          {children}
